...
Write-Host "KISA-2026 Vulnerability Assessment Scripts" -ForegroundColor Cyan
Write-Host "Copyright (c) 2026 SHIN HyeokSeon (신혁선). All rights reserved." -ForegroundColor Cyan
